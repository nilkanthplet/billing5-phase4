...
import { LogIn, UserPlus, Loader2, Eye, EyeOff, ArrowLeft, Zap, Shield } from 'lucide-react'
      ...
      <div className="w-full max-w-md p-6 bg-white border border-gray-200 rounded-lg shadow-md sm:p-8">
        ...
        <div className="mb-6 text-center">
          ...
          <h2 className="text-lg font-semibold text-gray-800">
            {mode === 'signup' 
              ? formStep === 0 ? 'નવું એકાઉન્ટ - ઇમેઇલ'
              : formStep === 1 ? 'નવું એકાઉન્ટ - પાસવર્ડ'
              : 'નવું એકાઉન્ટ - કન્ફર્મ'
              : 'સ્વાગત છે'
            }
          </h2>
        ...
        {/* Footer */}
        <div className="pt-4 mt-6 space-y-2 text-center border-t border-gray-200">
          ...
          <div className="flex flex-col items-center justify-center gap-2 text-xs sm:flex-row">
            <span className="px-2 py-1 text-blue-700 bg-blue-100 border rounded">
              <Zap className="inline w-3 h-3 mr-1" />
              Admin: nilkanthplatdepo@gmail.com
            </span>
            <span className="px-2 py-1 text-gray-600 bg-gray-100 border rounded">
